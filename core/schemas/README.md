...
| Config | Purpose | Status | Authorization |
|---|---|---|---|
| `../config/variant_taxonomy_v1.json` | Encodes the ICP Prism Doctrine's 34 named variants across 5 ICPs as shadow-mode runtime data for future classifier loading. Classifier wiring is future work and is not activated by this config. | Shadow mode | ICP Prism Doctrine v1 full taxonomy; THE BLEU BIBLE probabilistic variant blending; Total System Blueprint Section 8 variant-aware schema path. |
